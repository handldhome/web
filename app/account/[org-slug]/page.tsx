        ...
        <div className="max-w-5xl mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="font-semibold text-navy">{organization.name}</h1>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div className="bg-white rounded-2xl shadow-soft p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="font-semibold text-navy">Your Property</h2>
            </div>
              ...
              <div className="grid grid-cols-2 gap-4 pt-2">
                {customerProfile.square_footage && (
                  <div>
                    ...
                    <p className="text-navy font-medium">{customerProfile.square_footage.toLocaleString()} sq ft</p>
                  </div>
                )}
                {customerProfile.lot_size && (
                  <div>
                    <span className="text-gray-500">Lot Size</span>
                    <p className="text-navy font-medium">{customerProfile.lot_size.toLocaleString()} sq ft</p>
                  </div>
                )}
                {customerProfile.stories && (
                  <div>
                    <span className="text-gray-500">Stories</span>
                    <p className="text-navy font-medium">{customerProfile.stories}</p>
                  </div>
                )}
                {customerProfile.year_built && (
                  <div>
                    <span className="text-gray-500">Year Built</span>
                    <p className="text-navy font-medium">{customerProfile.year_built}</p>
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="space-y-3 text-sm">
              {organization.contact_email && (
                <div>
                  ...
                  <p>
                    <a href={`mailto:${organization.contact_email}`} className="text-brandBlue hover:underline">
                      {organization.contact_email}
                    </a>
                  </p>
                </div>
              ...
              {organization.contact_phone && (
                <div>
                  ...
                  <p>
                    <a href={`tel:${organization.contact_phone}`} className="text-brandBlue hover:underline">
                      {organization.contact_phone}
                    </a>
                  </p>
                </div>
          ...
          <div className="bg-white rounded-2xl shadow-soft p-6 opacity-75">
            <div className="flex items-center gap-3 mb-4">
            ...
            <p className="text-sm text-gray-500">Your quotes will appear here.</p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-soft p-6 opacity-75">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h2 className="font-semibold text-navy">Service History</h2>
                <span className="text-xs bg-gray-100 text-gray-500 px-2 py-0.5 rounded-full">Coming Soon</span>
              </div>
            </div>
            <p className="text-sm text-gray-500">Your service history will appear here.</p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-soft p-6 opacity-75">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h2 className="font-semibold text-navy">Book a Service</h2>
                <span className="text-xs bg-gray-100 text-gray-500 px-2 py-0.5 rounded-full">Coming Soon</span>
              </div>
            </div>
            <p className="text-sm text-gray-500">Schedule new services directly from your portal.</p>
          </div>
        </div>
      </main>
